...
class AppointmentController(http.Controller):
    ...
    @http.route('/hospital/appointments', auth='user', type='json')
    def appointment_banner(self):
        return {
            'html': """
                    <div>
                        <link>
                        <center><h1><font color="red">Hi...</font></h1></center>
                        <center>
...
class Hospital(http.Controller):
    ...
    def patient_webform(self, **kw):
        ...
        return http.request.render('hospital.create_patient', {'patient_name': 'Odoo Mates Test 123',
    ...
    #     return request.render("hospital.patient_webform", {})
    #
